  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px hsl(var(--primary) / 0.8)) drop-shadow(0 0 10px hsl(var(--secondary) / 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 15px hsl(var(--primary) / 1)) drop-shadow(0 0 25px hsl(var(--secondary) / 0.8))' },
        },
      },
      animation: {
