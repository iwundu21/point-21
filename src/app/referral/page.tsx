  ...
  const handleRedeemCode = async () => {
    ...
    try {
        ...
        if (updatedUser) {
            ...
            showDialog('Success!', 'You have received a 10 EXN bonus!');
        } else {
        ...
        <main className="flex-grow flex flex-col p-4 mt-8 relative">
            {isLoading ? null : (
                ...
                { !bonusApplied && (
                    ...
                    <div className="space-y-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Enter the code from your friend to get a <strong className="text-gold">10 EXN</strong> bonus.
                        </p>
                ...
                <div className="space-y-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Share your unique referral code with friends. When they sign up, you'll earn <strong className="text-gold">80 EXN</strong>, and they'll get a <strong className="text-gold">10 EXN</strong> head start! It's a win-win.
                  </p>
                ...
                <Separator className="w-full" />
                 ...
                 <div className="space-y-4 text-center">
                   ...
                   <div className="flex justify-between items-center p-4 bg-primary/5 rounded-lg">
                       ...
                       <span className="font-bold text-xl text-gold">{(friendsReferred * 80).toLocaleString()} EXN</span>
                   </div>
                 </div>
            </div>
            )}
