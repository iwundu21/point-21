...
export default function ProfilePage({}: ProfilePageProps) {
  ...
  const renderAccountStatus = () => {
    switch (accountStatus) {
        ...
        case 'detecting':
            return (
                <span className="text-yellow-400 font-bold flex items-center text-sm">
                    <Loader2 className="w-4 h-4 mr-1 animate-spin" /> Verification in Progress...
                </span>
            );
        case 'failed':
             return (
                <span className="text-red-400 font-bold flex items-center text-sm">
                 ...
                 <div className="w-full space-y-4 p-6 rounded-lg">
                    ...
                    {isVerifying ? (
                        ...
                        <div className='flex flex-col items-center justify-center gap-4 text-green-400 text-center p-4'>
                            ...
                            <p className="text-sm text-white/80 max-w-xs">Your account has been successfully verified. You can now close this message.</p>
